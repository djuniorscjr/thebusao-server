...
router.get('/api/v1/lines/', auth, IndexController.getSingleOrAllLines.bind(IndexController));
router.get('/api/v1/vehicles/', auth, IndexController.getSingleOrAllVehicles.bind(IndexController));
